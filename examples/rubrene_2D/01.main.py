...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--lattice-l1", type=int, default=80, help="number of tight-binding sites along easy direction")
    parser.add_argument("--lattice-l2", type=int, default=10, help="number of tight-binding sites along hard direction")
    ...
    parser.add_argument("--periodic", type=bool, default=False, help="use periodic boundary conditions for the tight-binding lattice")
...
def main() -> None:
    ...
    system_hamiltonian = tb_lattice.nearest_neighbor_hopping((hopping_l1, hopping_l2))  # 2D array shape: (system_dim, system_dim)
